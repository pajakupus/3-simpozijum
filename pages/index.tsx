...
export default function Home() {
  ...
  return <>
    ...
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-center justify-start text-left text-31xl text-bb-green font-manrope">
      ...
      <div className="w-[1440px] flex flex-col items-center justify-center py-16 px-2.5 box-border z-[5] text-[72px] text-seagreen">
        <div className="flex flex-row flex-wrap items-start justify-start gap-[58px]">
          <div className="flex flex-col items-start justify-start gap-[91px]">
            <div className="w-[726px] flex flex-col items-start justify-start gap-[64px]">
              <div className="flex flex-col items-start justify-start gap-[32px]">
                ...
                <div className="flex flex-col items-start justify-start text-[42px] text-plum">
                  <div className="w-[726.36px] relative tracking-[-0.05em] leading-[125%] font-medium inline-block">Agresija i nasilje, psiho(pato)loški aspekt - multidisciplinarni pristup</div>
                </div>
              </div>
            ...
            <div className="flex flex-col items-start justify-start gap-[16px] text-7xl text-white">
              <button type='button' onClick={() => scrollToFormSection()} className="w-[584px] rounded-13xl bg-seagreen shadow-[0px_2px_4px_rgba(48,_49,_51,_0.1),_0px_0px_1px_rgba(48,_49,_51,_0.05)] h-[76px] flex flex-row items-center justify-center py-6 px-12 box-border">
      ...
      <div className="w-[1440px] flex flex-row items-start justify-start p-20 box-border gap-[84px] z-[6] text-lg">
        <div className="self-stretch w-[620px] rounded-lg flex flex-col items-start justify-start gap-[24px]">
          ...
          <a href='https://maps.app.goo.gl/JWM9qMN9cZatsNoMA' target="_blank" rel="noreferrer"  className="self-stretch relative text-29xl [text-decoration:underline] text-seagreen">Kursumlijska Banja, hotel “Planinka”</a>
        </div>
        <div className="self-stretch w-[620px] rounded-lg flex flex-col items-start justify-start gap-[24px]">
          <div className="flex flex-row items-start justify-start gap-[4px]">
            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section ref={formSectionRef} id="form-section" className="w-[1440px] flex flex-row flex-wrap items-start justify-start p-20 box-border gap-[40px] z-[7]">
        {/* prvi deo forme */}
        <ProfileForm />
        {/* downloads */}
        <div className="w-[620px] flex flex-col items-center justify-center gap-[40px] text-center text-5xl">
          <b className="w-[400px] relative flex items-center justify-center">Preuzmite program i paket simpozijuma</b>
          <div className="w-[405px] flex flex-col items-start justify-start gap-[32px] text-left text-7xl text-white">
      ...
      <section className="w-[1440px] flex flex-col items-start justify-start p-20 box-border gap-[32px] z-[8]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[48px] text-lg text-gray font-dm-mono">
          <div className="w-[828px] flex flex-col items-start justify-start gap-[24px]">
            <div className="self-stretch relative tracking-[0.1em] leading-[14px] uppercase font-medium">Predsednik</div>
            <div className="self-stretch rounded-[123189px] bg-white overflow-hidden flex flex-row items-center justify-start p-5 gap-[48px] text-13xl text-black font-manrope border-[2px] border-solid border-teal">
              ...
              <div className="flex flex-col items-start justify-center gap-[8px]">
                <div className="relative tracking-[-0.05em] leading-[40px] font-medium">Prof. dr Suzana Tosic Golubovic</div>
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[24px]">
            ...
            <div className="self-stretch flex flex-row items-start justify-between text-13xl text-black font-manrope">
              <div className="flex flex-col items-start justify-start gap-[32px]">
                <div className="flex flex-col items-start justify-center gap-[8px]">
